...
#############varaible#########
weight_path = '/opt/ml/log/multi_label/final/mask/mask_2'
log_path = '/opt/ml/log/multi_label/final/mask/mask_2'
...
lr = 0.0001
classes = 3
train_mode = 'mask' #full, mask, gender, age
...
ls_w=0.0
fo_w = 1.0
focal_weight = torch.tensor([0.7, 1., 0.7]).cuda()
